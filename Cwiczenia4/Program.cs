...
namespace Program
{
    ...
    class Exercise1
    {
        ...
        {
            (int, int) pointChanged = point;
            switch (direction)
            {
                case Direction4.UP:
                    {
                        pointChanged.Item2 += -1;
                        if (pointChanged.Item2 < 0 || pointChanged.Item2 > screenSize.Item2)
                            return point;
                        else
                            return pointChanged;
                    }
                ...
                case Direction4.RIGHT:
                    {
                        pointChanged.Item1 += 1;
                        if (pointChanged.Item1 < 0 || pointChanged.Item1 > screenSize.Item1)
                            return point;
                        else
                            return pointChanged;
                    }
    ...
    public static void Main(string[] args)
    {
        ...
        Direction4 dir = Direction4.UP;
        var point2 = NextPoint(dir, point1, screenSize);
    }
}
