...
class App
{
    ...
    {
        Exercise1<string> team = new() { Manager = "Adam", MemberA = "Ola", MemberB = "Ewa" };
        foreach (var member in team)
        {
            Console.WriteLine(member);
        }

        var rates = new CurrencyRates<decimal, Currency>();
...
public class CurrencyRates<T, U> : IEnumerable where U : Enum // requires C# 7.3 or later
{
